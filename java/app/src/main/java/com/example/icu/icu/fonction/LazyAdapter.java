...
public class LazyAdapter extends BaseAdapter {
    ...
    public LazyAdapter(Activity a,ArrayList<HashMap<String,String>> ar) {
        arh=ar;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View vi=convertView;
        if(convertView==null)
            vi = inflater.inflate(R.layout.list_view_dernier_defi, null);

        // Déclaration des composant du layout

        TextView textRealisateurDefi = (TextView)vi.findViewById(R.id.realisateurDefi);
        ImageView photoProfil = (ImageView)vi.findViewById(R.id.photoProfil);

        TextView textDefi=(TextView)vi.findViewById(R.id.textViewDefi);
        ImageView imageDefi=(ImageView)vi.findViewById(R.id.imageViewPreuveDefi);
        final VideoView videoDefi = (VideoView)vi.findViewById(R.id.videoViewPreuveDefi);
        TextView textCommentaireRealisateurDefi = (TextView)vi.findViewById(R.id.commentaireRealisateurDefi);
        ...
        if (typePreuve.equals("photo")){
            ...
            videoDefi.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    Log.v("LazyAdapter", "video touché");
